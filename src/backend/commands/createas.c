...
static void intorel_startup(DestReceiver *self, int operation, TupleDesc typeinfo, uint64_t queryId);
 ...
 */
static void
intorel_startup(DestReceiver *self, int operation, TupleDesc typeinfo, uint64_t queryId)
{
